...
train_dataset.y[schizophrenia_pipeline.history[2]['indices_labeled']] = schizophrenia_pipeline.history[2]['indices_labels']

indices_initial = schizophrenia_pipeline.history[2]['indices_labeled']
...
study_name = "1605_schizophrenia_hpo"
...
def objective(trial):
    ...
    with open("trial_results_schizophrenia.jsonl", "a") as f:
...
with open("schizophrenia_sampler.pkl", "wb") as fout:
